...
import com.shami.zohaib.eaitit4free.CustomerData;
...
public class WeekModel implements Parcelable {
    ...
    public WeekModel(String week, String orderNumber, String orderTotal, String orderDateAdd, String orderPaymentStatus, String orderStatus, String deliveryType, String orderPaymentMethod, List<ItemData> itemData, CustomerData customerData) {
        this.week = week;
    ...
    public static final Parcelable.Creator<WeekModel> CREATOR = new Parcelable.Creator<WeekModel>() {
        @Override
